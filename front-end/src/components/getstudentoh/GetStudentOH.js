...
const GetStudentOH = ({ item: student_name }) => {
    ...
    return (
      <div>
        <h1 className="TableTitle">Office Hours for Student {student_name}</h1>
        {hours.length ? (
          ...
          <Alert variant="danger" className="ErrorMessage">No office hours recorded for {student_name}!</Alert>
        )}
      </div>
    );
  };
